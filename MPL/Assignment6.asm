;program to test if the processor is in protected mode and print the values of GDTR, LDTR, IDTR, TR, MSW.
...
next:
	...
	scall 1,1,regmsg,regmsg_len  ;printing register contents
...
;--- LDTR CONTENTS---- to find valid values for all labels after 1001 passes, giving up.
